        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <x-partials.card>
                ...
                <div class="mt-4 px-4">
                    ...
                    <div class="mb-4">
                        <h5 class="font-medium text-gray-700">
                            @lang('crud.statuses.inputs.client_id')
                        </h5>
                        <span
                            >{{ optional($status->client)->name ?? '-' }}</span
                        >
                    </div>
                    <div class="mb-4">
                        <h5 class="font-medium text-gray-700">
                            @lang('crud.statuses.inputs.event_id')
                        </h5>
                        <span>{{ optional($status->event)->name ?? '-' }}</span>
                    </div>
                </div>
            ...
            <x-partials.card class="mt-5">
                ...
                <livewire:status-works-detail :status="$status" />
            </x-partials.card>
            @endcan
        </div>
    </div>

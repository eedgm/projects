            ...
            <thead class="text-gray-700">
                <tr>
                    ...
                    <th class="px-4 py-3 text-left">
                        @lang('crud.product_works.inputs.client_id')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.product_works.inputs.date_start')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.product_works.inputs.date_end')
                    </th>
                    <th class="px-4 py-3 text-right">
                        @lang('crud.product_works.inputs.hours')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.product_works.inputs.statu_id')
                    </th>
                    <th></th>
                </tr>
            </thead>

        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <x-nav-dropdown title="Apps" align="right" width="48">
                        ...
                        @endcan
                        @can('view-any', App\Models\Field::class)
                        ...
                        <x-dropdown-link href="{{ route('product-descriptions.index') }}">
                        Product Descriptions
                        </x-dropdown-link>
                        @endcan
                        @can('view-any', App\Models\Work::class)
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-jet-responsive-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')">
                ...
                @endcan
                @can('view-any', App\Models\ProductDescription::class)
                <x-jet-responsive-nav-link href="{{ route('product-descriptions.index') }}">
                Product Descriptions
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Work::class)
                <x-jet-responsive-nav-link href="{{ route('works.index') }}">
                Works
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\User::class)
